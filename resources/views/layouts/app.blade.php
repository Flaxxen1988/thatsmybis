...
<body class="@yield('bodyClass')">
    ...
    <script src="https://momentjs.com/downloads/moment-with-locales.min.js"></script><!-- Date & time manipulation -->
    ...
    <script>
        @if (isset($guild) && $guild->expansion_id)
            ...
            @if(\Illuminate\Support\Facades\App::getLocale() != 'en')
                wowheadSubdomain = '{{ \Illuminate\Support\Facades\App::getLocale() }}' + '.' + wowheadSubdomain;
            @endif
